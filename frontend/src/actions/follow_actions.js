...
export const fetchFollows = () => dispatch => (
    FollowAPIUtil.fetchFollows()
      .then(result => dispatch(receivedFollows(result.data)))
)
...
export const followPlant = (plantId) => dispatch => (
    FollowAPIUtil.followPlant(plantId)
        .then(() => dispatch(receivedFollow(plantId)))
)
...
export const unfollowPlant = (plantId) => dispatch => (
    FollowAPIUtil.unfollowPlant(plantId)
        .then(() => dispatch(receivedUnfollow(plantId)))
)